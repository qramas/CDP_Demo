...
<html lang="fr">
   ...
   <body>
    ...
    `creneaux` = '$creneaux', `resume` = '$resume' WHERE `ateliers`.`id` =".$_GET['id'].";";
                ...
                <?php
           		...
           		else{ echo "Error: " . $sql . mysqli_error($conn) . $idU.$r[0]; ?>
         ...
         ?>
         <form class="form-horizontal col-sm-offset-2 col-sm-8" action="modification.php?id=<?php echo $_GET['id'] ?>" method="post">
